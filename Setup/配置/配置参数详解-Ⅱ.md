...
通过阅读文档 [[Failure detection id=&#39;78787f6a-1f80-4d86-a3ba-e1a0e5993eae&#39;]] 和 [[Configuration: Discovery, classifying servers id=&#39;b169c092-dcf3-4fe9-87ce-8cbe95b331e1&#39;]]可以发现, 这个参数还影响了不同场景下开启/关闭从库半同步的优先级. 举个例子, 一主N从, 当从库半同步数量小于`rpl_semi_sync_master_wait_for_slave_count` 时, 需要将哪些未开启半同步的从库的半同步参数开启. 那么先开谁的呢? 这个顺序就由`DetectSemiSyncEnforcedQuery` 查询返回值得大小来决定, 大的先开.
...
生成另一个专门用于orchestrator-agent([[Agents id=&#39;cce6fd11-0ddd-4d12-bf7e-2414454d4b32&#39;]])的HTTP接口 
...
另见[[Status Checks id=&#39;4b6601be-ae51-4f07-a0f6-36b6acbb4ce2&#39;]]
...
另见[[Configuration: Discovery, Pseudo-GTID id=&#39;f65504cf-f002-4cc4-beb7-acfac2b125c6&#39;]]
...
另见[[Configuration: Failure detection id=&#39;4124be88-14f6-4c3a-87c8-f4bb76e0b692&#39;]]
...
placeholders列表详见[[Configuration: Recovery id=&#39;1e244518-4a10-46c4-81b5-2da1c8998295&#39;]]
...
在[[Configuration: Recovery id=&#39;1e244518-4a10-46c4-81b5-2da1c8998295&#39;]]中有如下描述
