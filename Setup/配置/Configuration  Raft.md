...
### Backend DB
raft模式支持`MySQL`或`SQLite`作为后端数据库. 详见[[Configuration: Backend id=&amp;#39;51d20469-439a-451a-a336-6726cff3a142&amp;#39;]]. 阅读[[Orchestrator高可用 id=&#39;ed5e7b21-c508-44b8-817e-d7c782082cf3&#39;]], 了解使用这两种方法的情景、可能性和理由.
